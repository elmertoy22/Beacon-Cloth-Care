...
<?php
    ...
    /////displaying cart
    if(isset($_POST['warehousedisplay']))
    {
        $data =  '
        ...
        $displayquery = " SELECT * FROM `allsales` WHERE type_customer = 'Warehouse' "; 
    ...
    /////displaying cart
    if(isset($_POST['filtersales_warehouse']))
    {
        $data =  '
            <div class="tableFixHead">
                <table class="table table-striped">
                    ...
                    '; 
        $filtersales_warehouse = $_POST['filtersales_warehouse'];
        
        
        if ($filtersales_warehouse == "allsales"){
            $displayquery = " SELECT * FROM `allsales` WHERE type_customer = 'Warehouse'"; 
            $result = mysqli_query($connect,$displayquery);
            if(mysqli_num_rows($result) > 0){
                while ($row = mysqli_fetch_array($result)) {
           ...
           echo "NO DATA RECORDS";
            ...
            $displayquery = " SELECT * FROM `allsales` WHERE type_customer = 'Warehouse' and remark = '$filtersales_warehouse'"; 
            $result = mysqli_query($connect,$displayquery);
            if(mysqli_num_rows($result) > 0){
                while ($row = mysqli_fetch_array($result)) {
