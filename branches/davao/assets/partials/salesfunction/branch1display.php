...
<?php
    ...
    if(isset($_POST['branch1display']))
    {
        ...
        $displayquery = " SELECT * FROM `allsales` WHERE type_customer = 'Branch1' "; 
    ...
    /////displaying cart
    if(isset($_POST['filtersales_branch1']))
    {
        $data =  '
            <div class="tableFixHead">
                <table class="table table-striped">
        ...
        $filtersales_branch1 = $_POST['filtersales_branch1'];
        
        if ($filtersales_branch1 == "allsales"){
            $displayquery = " SELECT * FROM `allsales` WHERE type_customer = 'Branch1' "; 
            $result = mysqli_query($connect,$displayquery);
            ...
            $displayquery = " SELECT * FROM `allsales` WHERE type_customer = 'Branch1' and remark = '$filtersales_branch1'"; 
            $result = mysqli_query($connect,$displayquery);
